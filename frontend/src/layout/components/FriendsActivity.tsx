...
const FriendsActivity = () => {
  ...
  return (
    <div className="h-full glass rounded-lg flex flex-col">
      ...
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-4">
          {users.filter((user) => user.followStatus === "following").length >
          0 ? (
            users
              .filter((user) => user.followStatus === "following")
              .map((user) => {
                      ...
                      <div className="relative">
                        ...
                        <div
                          className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-black
													${onlineUsers.has(user.clerkId) ? "bg-green-500" : "bg-zinc-400"}
													`}
                          aria-hidden="true"
                        />
                      </div>
            ...
            <div className="text-center text-zinc-400 py-8">
              ...
              <p className="text-sm">Follow users to see their activity!</p>
            </div>
          )}
        </div>
      </ScrollArea>
